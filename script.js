...
/* ============================================================
   ENLACE DEL PDF — edita esta línea cuando tengas el enlace final
   (por ejemplo, un enlace para compartir de Google Drive).
   ============================================================ */
const PDF_URL = "#";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------- BOTÓN DE DESCARGA DEL PDF ----------
     Toma el enlace de la constante PDF_URL definida arriba y lo
     aplica al botón. Cuando tengas el enlace de Google Drive, solo
     hace falta reemplazar el valor de PDF_URL. */
  safeRun('download-pdf', () => {
    const downloadBtn = document.getElementById('downloadPdfBtn');
    if (downloadBtn && typeof PDF_URL !== 'undefined') {
      downloadBtn.setAttribute('href', PDF_URL);
    }
  });
